...
echo
echo "1. GitHub repo clone'lanıyor..."
sleep 2
...
echo
echo "2. Dockerfile oluşturuluyor..."
cat <<EOF > Dockerfile
...
echo "3. Docker imajı oluşturuluyor..."
echo "docker build -t izzeddincelik/sample_app ."
sleep 2
echo
echo "4. Image DockerHub'a  push ediliyor..."
echo "docker push izzeddincelik/sample_app"
sleep 2
echo

echo "5. Kubernetes definition file oluşturuluyor..."
echo
...
echo "6. Kubernetes Deployment - SVC - Ingress oluşturuluyor..."
sleep 2
kubectl apply -f k8s-goart-definition-file.yml

# Uygulama erişimini kontrol etme
echo
echo "7. Uygulama erişimi için Minikube Tunnel'in açık olduğundan emin olunuz..."
sleep 4

echo
echo "8. IP adresi ve port bilgileri alınıyor..."
...
# Uygulamayı test et
echo
echo "9. curl http://$IP:$PORT/WeatherForecast"
echo
